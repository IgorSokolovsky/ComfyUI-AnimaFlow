...
### 7c-0. Search must move to Civitai's MEILISEARCH endpoint (owner, 2026-08-02) — BUILT `dac7af1`
...
## 7c-0b. Implementation spec — the two-call search (2026-08-02) — BUILT `dac7af1`
