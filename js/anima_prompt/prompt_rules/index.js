 ...
 * `js/anima_prompt/prompt_builder` or `js/anima_prompt/prompt_combiner`) to both `Prompt Rules (CLIP)`
 ...
 *
 * Absolute imports for both cross-folder modules (`js/anima_prompt/rule_builder/`,
 ...
 * `js/anima_prompt/rule_builder/overlay.mjs`/`preview.mjs` already set that precedent for
 ...
 * import paths below (and their siblings in `js/anima_prompt/rule_builder/`) to match.
 */
...
function setupNode(node) {
  ...
  // `js/anima_prompt/prompt_combiner/index.js`'s `_promptCombinerRefs` existence check)
