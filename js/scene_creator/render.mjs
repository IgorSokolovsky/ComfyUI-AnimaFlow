 ...
 * see `js/prompt_builder/render.mjs`'s / `js/prompt_combiner/render.mjs`'s
...
// Palette + section layout lifted from js/prompt_builder & js/prompt_combiner
...
.wsc-root {
  ...
  /* NO height:100% and NO min-height here - deliberate (ComfyUI-Pixaroma
     find_replace pattern; see js/prompt_builder/render.mjs's header for the
     full rationale). */
}
...
// copied verbatim from js/prompt_builder/render.mjs & js/prompt_combiner/
