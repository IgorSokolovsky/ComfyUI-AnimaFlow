 ...
 *      EXACTLY, mirrors `js/prompt_builder/test_resize.mjs` and
 *      `js/prompt_combiner/test_resize.mjs`): `measureMinHeight` measures
 ...
 *
 * Run directly: `node js/scene_creator/test_resize.mjs` (plain script, no
 ...
 *       `/scripts/...` (absolute import works from the `js/scene_creator/`
 *       subfolder).
...
// ---- Minimal DOM stub (mirrors js/prompt_combiner/test_resize.mjs) -----
