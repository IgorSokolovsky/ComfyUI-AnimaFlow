 ...
 * imported) from `js/anima_prompt/prompt_builder/core.mjs` / `js/anima_prompt/prompt_combiner/
 ...
 * comments below) — `js/panel/scene_creator/render.mjs` uses them to compute a
