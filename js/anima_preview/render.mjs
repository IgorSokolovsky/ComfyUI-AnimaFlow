 ...
 * `js/prompt_combiner/index.js`'s TEMPLATE field), a square preview frame
 ...
 * `js/prompt_combiner`'s open-ended LIVE PREVIEW text block, there is no
...
// ---- Resize mechanism (matches js/prompt_combiner's, see that file's doc
