...
// model_picker.mjs / civitai_api.mjs / model_info.mjs / civitai_search.mjs /
// civitai_modal.mjs may ever import a `lora_*` module (that's the whole
// point of the split -- AnimaLoaderPanel imports the first four unchanged
// at M3, and a `lora_*` import here would mean M3 needs an extraction, not
// an import; `civitai_modal.mjs`, the M2b toolbar browser, is unscoped by
// design and has no business importing a track-specific module either).
// Precedent: js/shared/test_field_logic.mjs's own layering guard.
// ---------------------------------------------------------------------------
...
test("model_picker.mjs / civitai_api.mjs / model_info.mjs / civitai_search.mjs / civitai_modal.mjs never import a lora_* module (static OR dynamic import)", () => {
  const violations = [];
  let scanned = 0;
